<x-master>
    ...
    <div class="flex my-16 items-center flex-col flex-wrap" >
        ...
        <h3 class="font-bold text-4xl mb-6 text-gray-800 lg:text-2xl md:text-2xl sm:text-2xl xs:text-2xl">Search Category</h3>
        ...
        <form class="flex border-2 border-gray-400 rounded-lg p-1 w-full" method="get" action="/search">
            @csrf
            <input type="text" name="term" class="px-2 outline-none w-full border-0" placeholder="Search Category.." required>
    ...
    <h1 class="font-bold text-gray-700 text-xl py-2 mt-3">Topics in This Category</h1>
