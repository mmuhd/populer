                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap items-center  mb-2">
                            <button type="submit" class="bg-indigo-700 hover:bg-indigo-500 text-gray-100 font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline">
                                {{ __('Login') }}
                            </button>

                            @if (Route::has('password.request'))
                                <a class="text-sm text-gray-600  hover:text-blue-500 whitespace-no-wrap no-underline ml-auto" href="{{ route('password.request') }}">
                    ...
                    <form>
                        <div class="flex my-8 justify-center">
                            <div class="">
                                 <a href="{{ url('/login/facebook') }}" class="btn-outline"> Login With Facebook</a>
                            </div>
                        </div>
                    </form>
