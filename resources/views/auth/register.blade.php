                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex flex-wrap">
                            <button type="submit" class="inline-block align-middle text-center select-none border font-bold whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-gray-100 bg-indigo-700 hover:bg-indigo-500">
                                {{ __('Register') }}
                            </button>
                    ...
                    <form>
                        <div class="flex my-8 justify-center">
                            <div class="">
                                 <a href="{{ url('/login/facebook') }}" class="btn-outline"> Signup With Facebook</a>
                            </div>
                        </div>
                    </form>
